...
import org.restapi.com.messenger.exception.DataNotFoundException;
...
public class MessageService {
	...
	{
		messages.put(1L, new Message(1,"Hello Soren","Money Kukreja"));
		messages.put(2L, new Message(2,"Hi Money! How are you \\? ","Soren"));
